...
CREATE TABLE [FormFieldValue] (
    ...
    [FormFieldId] bigint NOT NULL,
    [CompletedFormId] bigint NOT NULL,
    CONSTRAINT [PK_FormFieldValue] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_FormFieldValue_CompletedForm_CompletedFormId] FOREIGN KEY ([CompletedFormId]) REFERENCES [CompletedForm] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_FormFieldValue_FormField_FormFieldId] FOREIGN KEY ([FormFieldId]) REFERENCES [FormField] ([Id]) ON DELETE NO ACTION
);
...
VALUES (CAST(1 AS bigint), '2019-05-16T00:00:00.0000000+02:00', CAST(1 AS bigint), CAST(1 AS bigint)),
(CAST(2 AS bigint), '2019-05-16T00:00:00.0000000+02:00', CAST(2 AS bigint), CAST(2 AS bigint)),
(CAST(3 AS bigint), '2019-05-16T00:00:00.0000000+02:00', CAST(3 AS bigint), CAST(3 AS bigint)),
(CAST(4 AS bigint), '2019-05-16T00:00:00.0000000+02:00', CAST(4 AS bigint), CAST(1 AS bigint)),
(CAST(5 AS bigint), '2019-05-16T00:00:00.0000000+02:00', CAST(5 AS bigint), CAST(2 AS bigint)),
(CAST(6 AS bigint), '2019-05-16T00:00:00.0000000+02:00', CAST(6 AS bigint), CAST(1 AS bigint)),
(CAST(7 AS bigint), '2019-05-16T00:00:00.0000000+02:00', CAST(7 AS bigint), CAST(1 AS bigint));
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CompletedDate', N'FormId', N'UserId') AND [object_id] = OBJECT_ID(N'[CompletedForm]'))
...
(CAST(3 AS bigint), 3, CAST(3 AS bigint), N'Antal kvæstede', 4, 3, 0, 3),
(CAST(4 AS bigint), 3, CAST(4 AS bigint), N'Overfaldsvåben', 5, 3, 0, 3),
(CAST(5 AS bigint), 3, CAST(5 AS bigint), N'Skal komunaldirektøren underrettes', 2, 3, 0, 5),
...
CREATE INDEX [IX_FormFieldValue_CompletedFormId] ON [FormFieldValue] ([CompletedFormId]);

GO

CREATE INDEX [IX_FormFieldValue_FormFieldId] ON [FormFieldValue] ([FormFieldId]);
